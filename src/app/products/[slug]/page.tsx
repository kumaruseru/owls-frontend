...
import { Star, ShoppingCart, Heart, Minus, Plus, Truck, Shield, ArrowLeft, Share2, Check, AlertCircle } from 'lucide-react';
import toast from 'react-hot-toast';
import { motion, AnimatePresence } from 'framer-motion';

import api from '@/lib/api';
import { useCartStore } from '@/store/cart-store';
import { cn, formatPrice } from '@/lib/utils'; // Giả sử bạn đã có formatPrice
...
export default function ProductDetailPage() {
    ...
    const fetchProduct = async () => {
        try {
            ...
            setSelectedImage(response.data.primary_image);
        } catch (error) {
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-black container mx-auto px-4 py-32 grid lg:grid-cols-2 gap-12">
                    ...
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-7 space-y-6">
                            <motion.div
                                ...
                                className="aspect-square bg-white/5 border border-white/10 relative group overflow-hidden rounded-3xl backdrop-blur-sm"
                            >
                                {selectedImage ? (
                                    <Image
                        ...
                        <div className="lg:col-span-5 flex flex-col">
                            <div className="sticky top-32 space-y-8 p-8 rounded-3xl bg-black/40 border border-white/10 backdrop-blur-xl shadow-2xl shadow-purple-900/5">
